    ...
    static class FrameSignIn extends JFrame implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            if (e.getSource() == buttonSubmitSignIn) {
                if (loginLabelSignIn.getText().isEmpty() || passLabelSignIn.getText().isEmpty()) { // Fixed condition
                    ...
                    try {
                        ...
                        HttpURLConnection connection = (HttpURLConnection) urlServer.openConnection(); // Fixed object creation

                        connection.setRequestMethod("POST"); // Fixed incorrect method name
